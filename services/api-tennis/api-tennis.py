...
def get_fixtures(date_start: str, date_stop: str, event_type_key: str, tournament_key: str, match_key: str, player_key: str):
    params = {
...
def get_live_scores(event_type_key: str, tournament_key: str, match_key: str, player_key: str):
    params = {
